...
class RemoteWhisperTranscriber(Transcriber):
    ...
    def get_segments_for_chunk(self, chunk_path: str, language: str) -> List[TranscriptionSegment]:
        with open(chunk_path, "rb") as f:
            self.logger.info(f"Transcribing chunk {chunk_path} with language {language}")
